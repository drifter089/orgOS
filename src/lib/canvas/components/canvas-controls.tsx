...
export type CanvasControlsProps = {
  ...
  /** Show keyboard shortcut "(T)" in add text tooltip (default: false) */
  showAddTextShortcut?: boolean;
};

/**
 * Shared canvas controls component.
 * Provides undo/redo, draw mode, add text, and force layout buttons.
 */
      ...
      <TooltipProvider>
        <div className="flex flex-col gap-2">
          ...
          <Tooltip>
            ...
            <TooltipContent side="right">
              <p>Add text{showAddTextShortcut ? " (T)" : ""}</p>
            </TooltipContent>
          </Tooltip>
